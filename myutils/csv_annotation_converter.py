...
#
#         img_path = f'{root_dir}_rgb/{sat_name}/{img_name}'
...
if __name__ == "__main__":
    ...
    # files_path = "./spark_dataset/validate_labels.csv"
    # json_file = "./spark_dataset/validate_labels.json"
    # json_convert(files_path, json_file)
